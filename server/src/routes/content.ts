...
router.post('/generate', async (req: Request, res: Response) => {
  try {
    ...
    // === 通用违禁词规则（抖音+小红书都必须遵守） ===
    const forbiddenWordsPrompt = `
【违禁词规避规则 - 绝对禁止使用】

1. 【表示权威性的违禁词】
   - 禁止使用：国家XX领导人推荐、国家XX机关推荐、国家XX机关专供、特供
   - 禁止使用：质量免检、无需国家质量检测、免抽检
   - 禁止使用：字号、中国驰名商标、特供、专供

2. 【首/家/国及相关词语】
   - 禁止使用：首个、首选、全球首发、全国首家、全网首发
   - 禁止使用：首家、首款、独家、独家配方、国家领导人
   - 禁止使用：国家级产品、全国销量冠军、国家免检、填补国内空白

3. 【含"最"及相关词语】
   - 禁止使用：最佳、最具、最爱、最赚、最优、最先进
   - 禁止使用：最优秀、最大程度、最低级、最高、最高级、最高档
   - 禁止使用：最奢侈、最低、最低价、最便宜、最舒适、最先进
   - 禁止使用：最流行、最符合、最先享受、最新科学、最新科技

4. 【包含"一"及相关词语】
   - 禁止使用：第一、中国第一、全网第一、销量第一、排名第一
   - 禁止使用：唯一、第一品牌、NO.1、TOP.1、独一无二
   - 禁止使用：全国第一、一流、仅此一次、最后一波、全国X大品牌之一

5. 【含"级/极"及相关词语】
   - 禁止使用：全球级、宇宙级、世界级、顶级、顶级工艺
   - 禁止使用：顶级享受、极品、极佳、绝对、终极、极致
   - 禁止使用：国家级（相关单位颁发的除外）

6. 【品牌地位的相关词语】
   - 禁止使用：王牌、世界领先、遥遥领先、领袖品牌、冠军
   - 禁止使用：领导者、缔造者、创领品牌、领先上市、楼王
   - 禁止使用：地王、领袖、巅峰、至尊、之王、王者
